...
export const BOTS = [
  { id: "rocky", nom: "Rocky", style: "L'agressif", desc: "adore la Pierre. Beaucoup trop.", elo: 1050, av: { fond: "terre", gant: "rouge", poignet: "noir", motif: "uni" } },
  { id: "miroir", nom: "Miroir", style: "Le copieur", desc: "rejoue souvent ton dernier coup.", elo: 1100, av: { fond: "court", gant: "blanc", poignet: "bleu", motif: "rayures" } },
  { id: "cyclo", nom: "Cyclo", style: "Le mécanique", desc: "tourne en boucle : Pierre, Feuille, Ciseaux.", elo: 1150, av: { fond: "gazon", gant: "jaune", poignet: "blanc", motif: "rayures" } },
  { id: "boomerang", nom: "Boomerang", style: "Le réactif", desc: "garde son signe quand il gagne, en change quand il perd.", elo: 1200, av: { fond: "violet", gant: "jaune", poignet: "rouge", motif: "etoile" } },
  { id: "chaos", nom: "Chaos", style: "L'imprévisible", desc: "joue au hasard total. Impossible à lire, impossible à piéger.", elo: 1250, av: { fond: "court", gant: "vert", poignet: "jaune", motif: "eclair" } },
  { id: "stratege", nom: "Stratège", style: "Le lecteur", desc: "analyse tes habitudes et les contre.", elo: 1300, av: { fond: "ardoise", gant: "rouge", poignet: "noir", motif: "eclair" } },
  { id: "professeur", nom: "Professeur", style: "Le maître", desc: "lit tes réflexes plus vite que son ombre.", elo: 1400, av: { fond: "or", gant: "blanc", poignet: "noir", motif: "etoile" } },
];
